    ...
    case WM_PAINT:
        {
            ...
            if (type==0) Image0(hdc, image1_x, image1_y, RGB(0, 0, 255));
            if (type == 1) Image1(hdc, image1_x, image1_y, RGB(0, 0, 255));
            if (type == 2) Image2(hdc, image1_x, image1_y, RGB(0, 0, 255));
            if (type == 3) Image3(hdc, image1_x, image1_y, RGB(0, 0, 255));
            if (type == 4) Image4(hdc, image1_x, image1_y, RGB(0, 0, 255));

           // Image3(hdc, image1_x, image1_y, RGB(0, 0, 255));
